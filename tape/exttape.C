...
/*
  ...
  $Log$
  Revision 1.3  1995/09/06 17:20:16  jussi
...
{
  if (argc < 4) {
    cerr << "Usage: " << argv[0] << " in-file out-file nrecs [-c]" << endl;
    cerr << "  produces specified number of records from in-file in out-file"
         << endl;
    exit(1);
  }
