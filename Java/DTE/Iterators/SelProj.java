...
public class SelProj implements Iterator 
{
  ...
  /** Argument: 
          inputit:  iterator on input relation; myselect: ExecExpr array, to test if the tuple satisfy the join condition; mywhere:  ExecExpr array, after testing the tuple belong to the result, use this to pick out fields in returned tuple, so the number of elements of this array should be the same as that of the returned tuple;typeStrings: TypeDesc array, specify the type of attributes of the returned tuple.*/
