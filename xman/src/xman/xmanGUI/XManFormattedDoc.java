//----------------------------------------------------------------------
// 
// File Name:    XManFormattedDoc.java
// 
// Description:  Experiment Management Format 
//
// Author:       Hao Wang
// 
// D.O.B.        02/07/2000
...
public class XManFormattedDoc extends PlainDocument {
    private Format format;

    public XManFormattedDoc(Format f) {
        format = f;
    }
