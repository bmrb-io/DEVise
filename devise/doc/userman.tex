...
environment (\code{.cshrc} file, etc.).  See the \code{<devisehome>/run/devise} script for
...
%Take this stuff out of here, since you can't specify a layout in the
%'Define Visualization' window.  See whether any of this information
%should be added to other sections.
...
If you have \code{New Mappings} selected, new mappings will always be generated
for the new views.  If you do not have \code{New Mappings} selected, and
...
select \code{New Mappings}.  Note that if you have more than one view with
