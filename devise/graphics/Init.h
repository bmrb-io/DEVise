...
/*
  ...
  $Log$
  Revision 1.38  2012/04/30 22:21:10  wenger
  Merged js_data_save_br_0 thru js_data_save_br_1 to trunk.

  Revision 1.37.12.1  2012/04/23 21:22:54  wenger
  ...
  Revision 1.37  2008/09/11 20:55:31  wenger
...
class Init {
  public:
    ...
    */
    ...
    static char *WorkDir() {
      // Make sure work dir exists (/tmp cleaner may delete it if
      // DEVise is idle for a long time).
      CheckAndMakeDirectory(_workDir, false, true);
      return _workDir;
    }
    static char *TmpDir() {
      // Make sure tmp dir exists (/tmp cleaner may delete it if
      // DEVise is idle for a long time).
      CheckAndMakeDirectory(_tmpDir, false, true);
      return _tmpDir;
    }
	...
	// The directory to put temp files into for JavaScreen data download.
	static const char *JSDataDownloadDir() { return _jsDataDownloadDir; }

	// The base URL to send back to the user for JavaScreen data download
	// (needs specific file name appended).
	static const char *JSDataDownloadUrl() { return _jsDataDownloadUrl; }
...
protected:
	...
	static const char *_jsDataDownloadDir;
	static const char *_jsDataDownloadUrl;
};
