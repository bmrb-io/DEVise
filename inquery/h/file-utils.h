...
/*
 * "FILE-UTILS_H" is a header file
 */

#if !defined(FILE_UTILS_H)
#define FILE_UTILS_H

static char file_utils_h_rcsid[]="$RCSfile$, $Revision$, $Date$";

/*
 *  Macros:
 */
#define file_comment_char(c) (c == '!')
#define file_skip_comment(f) (file_skip_to_eol(f))

/*
 *  Function Prototypes:
 */
void file_skip_to_eol (FILE *);
void file_skip_whitespace (FILE *);
void file_skip_this (FILE *, Char_t *);
void file_skip_to_this (FILE *, Char_t *);
