...
/* 
 * TL.H -- This file defines terms_t structure and its accessor fncs.
 */
 ...
 * Data types
 */
typedef struct terms terms_t;

/*
 * Accessor functions
 */
Int_t terms_count (const terms_t *terms);
Int_t inq_qbs_terms_read_index (const terms_t *terms, Int_t index, Char_t **term, Int_t *length);
void terms_free (terms_t *terms);
#endif /* TL_H */
