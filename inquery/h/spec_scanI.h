...
/*  
 *   This is the private header file for the spec_scan module
 */
...
struct ScanInfo
{
    char     *name;		/* Name to be printed during debugging */
    Int_t   (*func)();		/* The scanner function */
    Int_t   (*init)();		/* Function to be called before processing
				   first document (only) in a data set */
    BoolInt_t  on_off;		/* default setting */
    int     in_use;		/* Should I be run? */
    int     index;		/* where am I in scanner array */
};
