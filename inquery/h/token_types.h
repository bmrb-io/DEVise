...
/* Token flags */
#define INQ_TOK_LOCS   32 /* We keep position info for this token */
#define INQ_TOK_LEN    64 /* We keep length info for this token */

/* Token types */
#define INQ_WORD_NO_LOC_TOK   0
#define INQ_NUM_NO_LOC_TOK    1
#define INQ_STATIC_NO_LOC_TOK 2
#define INQ_SPEC_NO_LOC_TOK   3
#define INQ_DATE_NO_LOC_TOK   4

#define INQ_WORD_TOK        (INQ_WORD_NO_LOC_TOK | INQ_TOK_LOCS)
#define INQ_NUM_TOK         (INQ_NUM_NO_LOC_TOK | INQ_TOK_LOCS)
#define INQ_STATIC_TOK      (INQ_STATIC_NO_LOC_TOK | INQ_TOK_LOCS)
#define INQ_DATE_TOK        (INQ_DATE_NO_LOC_TOK | INQ_TOK_LOCS)
#define INQ_SPEC_TOK        (INQ_SPEC_NO_LOC_TOK | INQ_TOK_LOCS | INQ_TOK_LEN)
#define INQ_MUL_WORD_TOK    (INQ_WORD_TOK | INQ_TOK_LEN)

#define CMP_TYPE(a,b) (a == b)

/* These flags can be accessed with the CHECK_FLAG macros */
