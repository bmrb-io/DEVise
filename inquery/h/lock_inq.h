...
typedef enum { INQ_LOCK_READ, INQ_LOCK_WRITE, INQ_LOCK_FREE } Lock_t;
...
Int_t init_locking(char *lock_file, void **lock_ptr);
Int_t term_locking(void **lock_ptr);
Int_t set_lock(void *lock_handle, Char_t *key, Lock_t req_state);
