...
#if !defined (INQ_FEEDBACK_INFO_H)
#define INQ_FEEDBACK_INFO_H

int inq_get_feedback_dbid (void *info);
int inq_get_feedback_doc_cnt (void *info);
int inq_get_feedback_max_docs (void *info);
char *inq_get_feedback_dbname (void *info);
void *inq_get_feedback_data (void *info);
