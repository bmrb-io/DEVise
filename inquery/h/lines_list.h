...
/* A list of these (one for every line) of browser reply */
...
typedef struct lines_list_t {
  int room;                     /* how many lines are available */
  list_line_t **lines;
  int count;                    /* how many lines are filled in */
} lines_list_t;
