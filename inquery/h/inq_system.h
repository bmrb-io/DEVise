...
/*!************************************************************************
*! 
*! This .h file contains system level information.  It is not specific to
*! any particular application like inquery or inroute.
*!
*!*************************************************************************/

#if !defined (INQ_SYSTEM_H)
#define INQ_SYSTEM_H
...
struct loginstruct {
  conn_handle_t *connection;
  SecKey_t      *key;                  /* security ticket for a user */
};

typedef struct loginstruct Login_t;
