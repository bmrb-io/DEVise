...
\hline
tdata    & Schema name                & TData name, file path, TData type \\
...
The TData type parameter is either UNIXFILE or WWW. These are the two
types of data streams understood by the Devise server at this point.
