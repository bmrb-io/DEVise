...
/*
**  tempnam() has very hard problems on windows accepting a directory
...
MACINTOSH
  ...
  Metrowerks Codewarrior 6
   ...
   August 31, 1995 by Steven T. Roussey <sroussey@eng.uci.edu> (STR). and jeff@macalot.com
   (Jeff Dripps). Thanks a bunch!
