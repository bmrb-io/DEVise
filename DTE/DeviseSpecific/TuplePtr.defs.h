...
#ifndef _TuplePtrdefs_h
#define _TuplePtrdefs_h 1
...
// equality operator
#ifndef TuplePtrEQ
#define TuplePtrEQ(a, b)  ((a) == (b))
#endif

// less-than-or-equal
#ifndef TuplePtrLE
#define TuplePtrLE(a, b)  ((a) <= (b))
#endif

// comparison : less-than -> < 0; equal -> 0; greater-than -> > 0
#ifndef TuplePtrCMP
#define TuplePtrCMP(a, b) ( ((a) <= (b))? (((a) == (b))? 0 : -1) : 1 )
#endif

// hash function
#ifndef TuplePtrHASH
// extern unsigned int hash(TuplePtr );
// #define TuplePtrHASH(x)  hash(x)
#endif
