...
void BufMgrNull::InitGetRecs(TData *tdata, GData *,
...
Boolean BufMgrNull::DoPrefetch(RecId current, RecId &next){ return 0; }

/**** Policy ****/
/* Init buffer manager policy */
void BufMgrNull::InitPolicy(BufPolicy::policy policy){}

Boolean BufMgrNull::HasBuffer(){ return 0;}
void BufMgrNull::InitAllocBuf(int recSize, int numRecs){}
Boolean BufMgrNull::GetBuf(void *&buf, int &numRecs){ return 0;}
