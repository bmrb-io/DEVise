...
static char buf1[256], buf2[80],buf3[80],buf4[80],buf5[80], buf6[80];
 virtual void ViewXInfo::ParamNames(int &argc, char **&argv){
	int numDefaults;
	char **defaults;
...
ViewScatterInfo::~ViewScatterInfo(){
/*
printf("ViewScatterInfo destructor\n");
*/
	if (_view != NULL)
		delete _view;
}
