...
CallBackHandler
CBakInstall(int index, CallBackHandler handler) {
	CallBackHandler prevhandle;

	prevhandle = CBakArray[index];
	CBakArray[index] = handler;
	return prevhandle;
}

CallBackHandler
CBakUnInstall(int index) {
	CallBackHandler prevhandle;

	prevhandle = CBakArray[index];
	CBakArray[index] = NULL;
	return prevhandle;
}
