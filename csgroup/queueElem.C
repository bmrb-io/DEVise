...
QueueElem::QueueElem(const QueueElem& qe) {
...
void
QueueElem::setelement(Datum* d) {

	element = d;
}

void
QueueElem::setnext(QueueElem *nxt) {
...
ostream&
operator<<(ostream& os, const QueueElem& qe) {
