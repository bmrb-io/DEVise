 ...
 *2 local_inv (in_retrieval, results, inst)
 *3   RETRIEVAL *in_retrieval;
 *3   RESULT *results;
 *3   int inst;
 *4 init_local_inv (spec, unused)
...
/* Changes from sim_vec_inv to local_inv:
...
char *unused;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering init_local_inv");
    ...
    if (NULL == (full_results = (float *) 
        ...
        set_error (errno, "", "local_inv");
        return (UNDEF);
    }

    PRINT_TRACE (2, print_string, "Trace: leaving init_local_inv");
    return (0);
}

int
local_inv (in_retrieval, results, inst)
...
int inst;
{
    ...
    PRINT_TRACE (2, print_string, "Trace: entering local_inv");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving local_inv");
    return (1);
}


int
close_local_inv (inst)
int inst;
{
    long i;
    PRINT_TRACE (2, print_string, "Trace: entering close_local_inv");
    ...
    PRINT_TRACE (2, print_string, "Trace: leaving close_local_inv");
    return (0);
}
